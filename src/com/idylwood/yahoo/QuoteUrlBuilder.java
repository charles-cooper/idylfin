...
public class QuoteUrlBuilder extends UrlBuilder {
	...
	public enum Tag
	{
		...
		PRICE_EARNINGS_RATIO_REALTIME("r2"),
		PRICE_EARNINGS_TO_GROWTH_RATIO("r5"),
		PRICE_EARNINGS_RATIO_ESTIMATE_CURRENT_YEAR("r6"),
		PRICE_EARNINGS_RATIO_ESTIMATE_NEXT_YEAR("r7"),
		SHORT_RATIO("s7"),
